...
class DEFLATE
{
	...
	static void		decode_Huffman(BitStream & bits, HuffmanTree & literal, HuffmanTree & distance, ByteStreamQueue & data);

	public:
	static void	Block_direct(BitStream & bits, ByteStreamQueue & data);
	static void	Block_static(BitStream & bits, ByteStreamQueue & data);
	static void	Block_dynamic(BitStream & bits, ByteStreamQueue & data);
	static void	Blocks(BitStream & bits, ByteStreamQueue & data);
